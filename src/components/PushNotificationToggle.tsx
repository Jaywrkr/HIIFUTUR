...
export function PushNotificationToggle() {
  ...
  if (status === "unsupported") {
    return (
      <p className="text-sm text-neutral-500">
        Tu navegador no soporta notificaciones push. En iPhone, agrega EJECUTA a tu pantalla de
        inicio primero.
      </p>
    );
  }
  ...
  if (status === "denied") {
    return (
      <p className="text-sm text-neutral-500">
        Bloqueaste las notificaciones para EJECUTA. Actívalas desde la configuración de tu
