...
CREATE INDEX IF NOT EXISTS "feedback_messages_user_id_idx" ON "feedback_messages" USING btree ("user_id");
CREATE INDEX IF NOT EXISTS "habit_freezes_habit_id_idx" ON "habit_freezes" USING btree ("habit_id");
CREATE INDEX IF NOT EXISTS "habit_logs_habit_id_date_idx" ON "habit_logs" USING btree ("habit_id","date");
